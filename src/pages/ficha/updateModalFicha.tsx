...
import { useUpdateCellMutation, CellStatusEmun, FichaTecnica, useUpdateFichaTecnicaMutation, FichaTecnicaEnum } from "../../domain/graphql";
...
const statusOptions: Option[] = [
  { value: FichaTecnicaEnum.Active, label: "Activo" },
  { value: FichaTecnicaEnum.Inactive, label: "Inactivo" }
];
...
export const UpdateFichaModal: React.FC<UpdateCellModalProps> = ({ isOpen, closeModal, openModal, ficha }) => {
  if(!ficha) return null;
  const [updateCell] = useUpdateFichaTecnicaMutation();
  ...
  const [status, setStatus] = useState<FichaTecnicaEnum>(ficha.status);
      ...
      <div className="flex flex-col px-2 overflow-y-auto custom-scrollbar">
        ...
        <div className="mt-4">
          ...
          <SearchableSelect
            ...
            onChange={(value) => setStatus(value as FichaTecnicaEnum)}
            defaultValue={status}
          />
        </div>
        <div className="mt-4">
